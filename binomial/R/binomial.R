...
# author: Yi-Chen Chen
# date: April 28, 2019
# discription: creat a "binomial" package with different functions
#
# ------------------------------------------------------------------------------------------
...
#' @description return a data frame with the probability distribution: successes in the first column, probability in the second column
#' @param trials the number of (fixed) trials
#' @param prob the probability of success on each trial
...
#' @description return a data frame with both the probability distribution and the cumulative probabilities: successes in the first column, probability in the second column, and cumulative in the third column
#' @param trials the number of (fixed) trials
#' @param prob the probability of success on each trial
